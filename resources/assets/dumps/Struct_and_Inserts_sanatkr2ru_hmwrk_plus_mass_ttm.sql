...
--
-- Хост: localhost
-- Время создания: Мар 30 2018 г., 00:37
...
(1, 1, 'материалы для 1 класса', 'no image', 'Таблица умножения на 2', '2 × 1	 = 	2\r\n2 × 2	 = 	4\r\n2 × 3	 = 	6\r\n2 × 4	 = 	8\r\n2 × 5	 = 	10\r\n2 × 6	 = 	12\r\n2 × 7	 = 	14\r\n2 × 8	 = 	16\r\n2 × 9	 = 	18\r\n2 × 10	 = 	20', '2018-03-29 18:14:58', '2018-03-29 18:14:58');
...
(2, 1, 'задачи для 1 класса', 'На одной странице 5 рисунков. Сколько рисунков на 2 таких же страницах?', '10', '2018-03-29 18:16:59', '2018-03-29 18:16:59'),
(3, 1, 'составные задачи для 1-2 класса', 'Маша съела 4 мандарина, а Саша съел на 2 мандарина меньше Маши.\r\nСколько всего мандаринов съели ребята?', '6', '2018-03-29 18:17:32', '2018-03-29 18:17:32'),
(4, 1, 'задачи для младших классов', 'Сравни выражения:\r\n10 + 25 ? 15 + 20.\r\nКакой знак нужно вставить', '=', '2018-03-29 18:18:42', '2018-03-29 18:18:42'),
(5, 1, 'задачи на гибкость мышления для младших классов', 'Лена живет на 4 этаже, если считать сверху. На каком этаже живет Лена, если всего у дома 9 этажей?', '6', '2018-03-29 18:19:23', '2018-03-29 18:19:23'),
(6, 2, 'задачи для младших классов', 'Оля вырезала из бумаги 5 квадратов, 7 треугольников, а кругов в 2 раза больше чем треугольников. Сколько всего Оля вырезала фигур?', '26', '2018-03-29 18:32:38', '2018-03-29 18:32:38');
...
(1, 1, 'тесты по математике для младших классов', 'На столе лежали ручки, карандаши и фломастеры, всего 15 штук. Карандашей было в 7 раз больше, чем ручек. Сколько фломастеров лежало на столе?', '1', '14', '7', '10', 'C', '2018-03-29 18:10:37', '2018-03-29 18:10:37'),
(2, 1, 'тесты по математике для младших классов', 'У Саши и Коли вместе 18 марок. Саше подарили еще 8. Сколько после этого стало марок у мальчиков?', '26', '25', '35', '12', 'A', '2018-03-29 18:11:37', '2018-03-29 18:11:37'),
(3, 1, 'тесты по математике для младших классов', 'Значение какого выражения равно 14 ?', '6 + 7', '5 + 9', '7 + 5', '4 + 11', 'B', '2018-03-29 18:12:14', '2018-03-29 18:12:14'),
(4, 2, 'тесты по математике для 2 класса', 'В парке выкорчевали 6 орешников, а вместо них посадили 18 орешников. Во сколько раз больше посадили орешников, чем выкорчевали?', '3', '2', '18', '6', 'A', '2018-03-29 18:33:34', '2018-03-29 18:33:34'),
(5, 2, 'тесты по математике для младших классов', 'В книжный магазин привезли 240 книг. Из них 70 поставили на верхнюю полку, 120 на среднюю, а остальные на нижнюю. Сколько книг поставили на нижнюю полку?', '70', '30', '50', '120', 'C', '2018-03-29 18:36:42', '2018-03-29 18:36:42');
...
(1, 'a', 'admin', NULL, '$2y$10$99IMnyx88bQfmNiyqG7tteHNxc4TCHWzb9tZ.HpuUqS7RmtUra71K', 'xV2oxcjNl9zMmhAlow7nh59qfmjKdzWLyUOSSe1GSJog9SJVSv35vNUuiLcD', NULL, NULL),
(2, 't', 'teach', NULL, '$2y$10$.q7giqrE.8K9QRIb5Ghr2e/Xl08DcVvyOcg1XeJQzTE95AZpIHLf.', 'xIGGODLHKcjtvSLIcIX7NCNDFNvacFiZIohCcmkiDFkOvtH9c24XqVHNcT8s', '2018-03-28 22:26:38', '2018-03-28 22:26:38'),
...
(4, 't', 'teach1', NULL, '$2y$10$reI0MpP3kJgI8yYUAa2Q9.y0OtYm7Qm1yAmnAKx.UpfCUM/Nstqq2', 's19ehBJmZO4khqA60b9wJLJMP98iQRUiFnEgXzlUD2LlLM9LyYeYpJ8DQQ8u', '2018-03-29 10:29:10', '2018-03-29 10:29:10'),
...
(8, 't', 'teach5', NULL, '$2y$10$Ld6Sp.0J1RB7nMVL2E.I9OCgMo19vlSvVCu9wL.n3/iCAHpsFxz9e', 'nLrd7fWQzzr62Y8m60MIZDCsUzwy13NOw2mwnUU5e8BajgbzTQmZpsWVlxmg', '2018-03-29 11:17:52', '2018-03-29 11:17:52'),
